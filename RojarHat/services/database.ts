...
export const databaseService = {
    ...
    async createOrder(orderData: OrderData) {
        try {
            ...
            const localOrders = JSON.parse(localStorage.getItem('rojarhat_orders') || '[]');
            const newOrder = {
            ...
            localStorage.setItem('rojarhat_orders', JSON.stringify(localOrders));
    ...
    getLocalOrders() {
        return JSON.parse(localStorage.getItem('rojarhat_orders') || '[]');
    },
