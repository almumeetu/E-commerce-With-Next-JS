# RojarHat (রোজারহাট) - Project Documentation & Developer Guide

## 🌟 Overview
RojarHat is a premium E-commerce platform built for the Ramadan season. It has been migrated from a static Vite application to a high-performance **Next.js 14 (App Router)** site with a **Supabase** backend.
...
Welcome to RojarHat! Here are a few things to keep in mind:
...
---
© 2026 RojarHat Team | Optimized for Performance & Scalability.
