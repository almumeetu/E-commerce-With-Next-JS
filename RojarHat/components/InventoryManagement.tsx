...
export default function InventoryManagement() {
  ...
  const getStockStatus = (product: Product) => {
    ...
    return { status: 'in_stock', text: 'স্টক আছে', color: 'emerald' };
  };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="flex gap-4">
            ...
            <button className="bg-emerald-600 text-white px-6 py-3 rounded-2xl font-bold flex items-center gap-2 hover:bg-emerald-700 transition shadow-lg shadow-emerald-500/20">
              <Plus size={20} />
              <span>নতুন পণ্য</span>
            </button>
          </div>
                ...
                <tbody className="divide-y divide-stone-50">
                  {transactions.map((transaction) => (
                    <tr key={transaction.id} className="hover:bg-stone-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`text-xs font-bold px-2 py-1 rounded-full ${
                          transaction.transaction_type === 'purchase' ? 'bg-emerald-100 text-emerald-700' :
                      ...
                      <td className="px-6 py-4">
                        <span className="font-bold text-emerald-900">৳{transaction.total_cost || 0}</span>
                      </td>
                      <td className="px-6 py-4">
