                    ...
                    <div className="flex flex-col lg:flex-row">
                        ...
                        <div className="lg:w-1/2 p-8 lg:p-16 flex flex-col">
                            <div className="mb-auto">
                                <span className="text-indigo-600 font-bold uppercase tracking-widest text-sm mb-3 block">{product.category}</span>
                                <h1 className="text-3xl lg:text-5xl font-black text-stone-950 mb-6 leading-tight">{product.name}</h1>

                                <div className="flex items-center gap-6 mb-8">
                                    <span className="text-4xl font-black text-indigo-800">৳ {product.price}</span>
                                    <div className="h-10 w-px bg-stone-200" />
                                    <div className="flex items-center gap-2 text-indigo-600 font-bold bg-indigo-50 px-4 py-2 rounded-2xl border border-indigo-100">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-12">
                                <button
                                    ...
                                    className="flex items-center justify-center gap-3 bg-white border-4 border-indigo-900 text-indigo-900 py-5 rounded-[24px] font-black text-lg hover:bg-indigo-50 transition-all shadow-xl shadow-indigo-900/5 group"
                                >
                                    <ShoppingCart size={24} className="group-hover:-translate-y-1 transition-transform" /> কার্টে যোগ করুন
                                </button>
                                <button
                                    onClick={handleBuyNow}
                                    className="flex items-center justify-center gap-3 bg-indigo-900 text-white py-5 rounded-[24px] font-black text-lg hover:bg-indigo-950 transition-all shadow-xl shadow-indigo-900/20 group"
                                >
