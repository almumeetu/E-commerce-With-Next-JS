...
import { Search, Eye, CheckCircle, Truck, XCircle, Clock, Calendar, Phone, MapPin, DollarSign, Package, X, ShoppingBag, Filter, Download, TrendingUp, ChevronDown } from 'lucide-react';
import { databaseService } from '../services/databaseService';

export default function AdminOrdersClone() {
    ...
    async function handleStatusUpdate(id: string, status: string) {
        ...
        if (res.success) {
            alert('অর্ডার স্ট্যাটাস আপডেট করা হয়েছে');
            loadOrders();
        } else {
    ...
    return (
        <div className="space-y-8 pb-10">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                <div>
                    <h2 className="text-3xl font-black text-stone-900 tracking-tight">অর্ডার ব্যবস্থাপনা (Clone)</h2>
